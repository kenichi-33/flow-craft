        ...
        <>
            <div
                className={`min-w-[140px] min-h-[60px] px-4 py-2 rounded-lg flex flex-col items-center justify-center shadow-lg border-2 relative transition-all duration-300
                    ${data.isFailed ? 'bg-red-50 to-red-100 border-red-500 shadow-red-200' : 
                      data.isCurrent ? 'bg-gradient-to-br from-yellow-400 to-yellow-600 border-yellow-400 ring-4 ring-yellow-400/30' : 
                      'bg-gradient-to-br from-yellow-400 to-yellow-600 border-white/50'}
                `}
            ...
            >
                ...
                <Handle 
                    ...
                    className="!bg-white !border-2 !border-yellow-700 !w-2.5 !h-2.5 !rounded-none" 
                />
                <div className="flex items-center gap-1">
                    <Clock className="h-4 w-4 text-white" />
                    <span className="text-sm text-white font-bold drop-shadow-sm">{config.label || '待機 (タイマー)'}</span>
                    {!readOnly && (
                ...
                <Handle 
                    ...
                    className="!bg-yellow-700 !w-2.5 !h-2.5 !border-2 !border-white !rounded-full" 
                />
                {/* Stats Badge */}
                {(() => {
