...
import { DynamicOptionsSettings } from './properties/DynamicOptionsSettings';
import { MasterConnectorSettings } from './properties/MasterConnectorSettings';
...
export default function FormEditorProperties({ 
    ...
    return (
        <div className="p-4 space-y-5">
            ...
            {/* Dynamic Options Setting */}
            {['select', 'radio', 'checkbox'].includes(field.type) && (
                <div className="space-y-3 pt-2 border-t">
                    <Label className="text-xs font-semibold">動的選択肢設定 (連動)</Label>
