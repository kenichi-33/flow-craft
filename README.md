...
108: 
109: ### 6. AIチャット機能 (AI Start Node)
110: - **対話型申請**: 自然言語でチャットしながら申請を作成・実行
111: - **複数アプリ検出**: "出張と経費精算"のような複合的な意図を理解し、適切なアプリを自動選択
112: - **詳細設計**: [backend/docs/ai_features.md](./backend/docs/ai_features.md)
113: 
